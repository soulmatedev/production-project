...
export default {
    ...
    // searched recursively up from the requiring module's location

    // An array of file extensions your modules use

    // A map from regular expressions
    // to module names or to arrays of
    ...
    // URL for the jsdom environment. It is reflected in properties such as location.href
